...
CREATE TABLE TAREA_USUARIO(
    TARE_USUA_ID INT IDENTITY(1 ,1),
    TARE_ID INT,
    USUA_ID INT,
    CONSTRAINT PK_TARE_USUA PRIMARY KEY (TARE_USUA_ID),
    CONSTRAINT FK_TARE_USUA_TARE FOREIGN KEY (TARE_ID) REFERENCES TAREA(TARE_ID) ON DELETE CASCADE,
    CONSTRAINT FK_TARE_USUA_USUA FOREIGN KEY (USUA_ID) REFERENCES USUARIO(USUA_ID) ON DELETE CASCADE
);